...
r=2
   ...
   plot_two_cdfs_continuous(region, corestart, coreend, edgestart, edgeend, titlestring, max);
   stem(14.95, 0.90, 'color', [0.4660 0.6740 0.1880])
  % stem(15.93, 0.90, 'color', [0.4940 0.1840 0.5560])
    ...
    legend({'adiabatic updraft', 'edge region'}, 'location', 'southeast')
    xlim([12 max])
