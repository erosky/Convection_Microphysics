...
%     edge_vwind_min = [edge_vwind_min; min(vwind_edge)];
    ...
    fig1 = figure(1);
    for R = 1:height(timestamps)
    scatter(cell2mat(lwcratio_edge(R)), cell2mat(Dratio_edge(R)), 50, CM(R,:), "o");
    hold on
    scatter(cell2mat(lwcratio_core(R)), cell2mat(Dratio_core(R)), 50, CM(R,:), "filled");
    end
    hold off
    ...
    fig2 = figure(2);
    for R = 1:height(timestamps)
    scatter(cell2mat(lwc_edge_list(R)), cell2mat(Dratio_edge(R)), 50, CM(R,:), "o");
    hold on
    scatter(cell2mat(lwc_core_list(R)), cell2mat(Dratio_core(R)), 50, CM(R,:), "filled");
    end
    hold off
