 function out = spicule_get_incloudonly_data(region, flightnumber)
    ...
    folder = fullfile(directory, '/EdgeCloud');
    ...
    for p = 1 : size(timestamps)
        ...
        starttime = timestamps.StartTime(p);
        endtime = timestamps.EndTime(p);
